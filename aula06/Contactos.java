...
public class Contactos {
    ...
    public Contactos(int num, String email, Pessoa pessoa) {
        this.num = num;
        this.email = email;
        this.pessoa = pessoa;
        this.id = idCounter++;
    ...
    public void inserirContacto(Contactos contacto) {
    ...
    public String listarContactos() {
        ...
        for (Contactos contacto : contactos) {
            sb.append("ID: ").append(contacto.getId()).append(", Email: ").append(contacto.getEmail()).append(", Número: ").append(contacto.getNum()).append("\n");
        }
        return sb.toString();
    }
    @Override
